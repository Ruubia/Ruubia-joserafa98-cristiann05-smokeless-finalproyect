...
const SignupCoach = () => {
    ...
    const handleSignup = async (event) => {
        ...
        setError("");
        setSuccessMessage(""); // Resetea el mensaje de éxito al iniciar el registro
        ...
        if (success) {
            setSuccessMessage("Registro exitoso. Redirigiendo a inicio de sesión..."); // Mensaje de éxito
            ...
            <div className="col-md-6 col-lg-5 col-xl-5 position-fixed start-0 top-0 vh-100 overflow-y-hidden d-none d-lg-flex flex-lg-column">
                <div className="p-12 py-xl-10 px-xl-20">
                    ...
                    <div className="mt-1 text-center px-5">
                        <h1 className="ls-tight fw-bolder display-6 text-white mb-1">
                            ¡COMIENZA HOY!
                        </h1>
            ...
            <div className="col-12 col-md-12 col-lg-7 offset-lg-5 min-vh-100 overflow-y-auto d-flex flex-column justify-content-center position-relative bg-body rounded-top-start-lg-4 rounded shadow-soft-5">
                <div className="w-md-50 mx-auto px-10 px-md-0 py-10">
                    <div className="mb-10">
                        ...
                        <h1 className="ls-tight fw-bolder h1">Registrate como coach</h1>
                        <p>¿Ya tienes una cuenta? <Link to="/login-coach" className="text-primary">Inicia sesión aquí</Link>.</p>
                    </div>
                    ...
                    <form className="form" onSubmit={handleSignup} style={{ fontSize: '1.25rem' }}>
                        ...
                        <button className="btn btn-dark w-100" type="submit" style={{ fontSize: '1.25rem', padding: '15px' }}>Registrarse</button>
                    </form>
                </div>
            </div>
        </div>
